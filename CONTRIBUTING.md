...
- I Clone from legger du inn følgende url `https://github.com/Informasjonsforvaltning/veileder-begrepsbeskrivelser.git`

Alternativt i kommando-linje:

```Shell
% git clone https://github.com/Informasjonsforvaltning/veileder-begrepsbeskrivelser.git
% cd veileder-begrepsbeskrivelser
...
Gå til <https://github.com/Informasjonsforvaltning/veileder-begrepsbeskrivelser/pulls> og opprett `New pull request`
...
bash-5.0# asciidoctor-pdf -a lang=nb -D docs -o files/veileder-begrepsbeskrivelser.pdf docs/main.adoc
```
